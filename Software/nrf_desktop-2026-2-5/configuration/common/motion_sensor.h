...
enum motion_sensor_option {
 ...
 static const int motion_sensor_option_attr[MOTION_SENSOR_OPTION_COUNT] = {
	...
	/* PMW3389 manages its own downshift/sample-rate timers internally.
	 * Reporting -ENOTSUP for these causes motion_sensor.c to log a
	 * harmless "Sensor option N is not supported" message and move on. */

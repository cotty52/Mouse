...
/* P0.04 is AIN2 on nRF52840 - check nice!nano schematic, usually P0.31 is AIN7 or similar. 
   nice!nano v2 measures battery on P0.31 which is AIN7.
*/
#define BATTERY_MEAS_ADC_INPUT		NRFX_ANALOG_EXTERNAL_AIN7
